...
Public Class card_item_min
    ...
    Private Sub card_item_min_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Loads()
    End Sub
    ...
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles PictureBox1.Click
        Connect()
        conn.Open()
        Dim query As String = "SELECT * FROM film WHERE id_film = @id_film"
        ...
        infoFilm.lblJudul.Text = reader("judul").ToString()
        infoFilm.lblGenre.Text = reader("genre").ToString()
    ...
    Private Sub btnFavorit_Click(sender As Object, e As EventArgs) Handles btnFavorit.Click
        ...
        End If
        conn.Close()
        Dim parent As Control = Me.Parent.Parent.Parent.Parent
        If TypeOf parent Is explore Then
            Dim p As explore = CType(parent, explore)
            p.Loads()
        End If
